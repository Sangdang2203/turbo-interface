...
import global_icon from "@/images/cloudFlare/global_icon.png";
import object_icon from "@/images/cloudFlare/Object_icon.png";
import cost_icon from "@/images/cloudFlare/Cost_icon.png";
import IPFS_thumbnail from "@/images/cloudFlare/IPFS_thumbnail.png";
import ethereum_icon from "@/images/cloudFlare/ethereum_icon.png";
...
export const cloudflareEthereum = [
  ...
  {
    id: 5,
    title: "Đơn giản hóa việc phát triển ứng dụng Ethereum",
    image: "",
...
export const cloudflareIpfs = [
  ...
  {
    id: 2,
    title: "Tích hợp với các dịch vụ của Cloudflare",
    image: "",
  ...
  {
    id: 4,
    title: "Tính linh hoạt và dễ sử dụng",
    image: "",
