...
import centralized_agent_deployment_and_management from "../../../../public/images/veemBackup/centralized-agent-deployment-and-management.png.web_.1280.1280.webp"
import veemBackup from "../../../../public/images/veemBackup/veeam-1600x800-og-vbr.png"
import veeam_img01 from "../../../../public/images/veemBackup/veeam_img01-1.png"
import icon_01 from "../../../../public/images/veemBackup/icon_01.png"
import icon_02 from "../../../../public/images/veemBackup/icon_02.png"
import veeam_azure from "../../../../public/images/veemBackup/veeam-azure-img01.png"
import manager_interface from "../../../../public/images/veemBackup/manager_interface.png"
  ...
  return (
    <Container>
      <Box my={5} sx={{ textAlign: "center", marginX: "auto" }}>
        <Typography className="text-[2rem] text-center text-blue-900 font-semibold">Giải pháp sao lưu, phục hồi và quản lý dữ liệu trên đám mây</Typography>
      ...
      <Box sx={{ position: "relative" }}>
        <Image src={veemBackup} title="Veeam Backup" className="w-full min-h-[700px] rounded-lg" alt="Veeam Backup"></Image>
        ...
        <Card className="py-10">
          <Grid container>
            <Grid item xs={12} md={6} lg={6} xl={6} className="flex flex-col items-center justify-center">
              <Box textAlign="center" my={3} p={3}>
                <Typography className="text-[1.5rem] text-green-600">Giải pháp số #1 để sao lưu dữ liệu quan trọng</Typography>
                <Typography className="text-lg text-gray-400">Nền tảng sao lưu đám mây dành cho tất cả các ứng dụng và dữ liệu, giúp đạt được thời gian sao lưu ngắn hơn và giảm chi phí hoạt động tối ưu.
            ...
            <Grid item xs={12} md={6} lg={6} xl={6} >
              <Image src={centralized_agent_deployment_and_management} className="w-full h-auto" alt="centralized_agent_deployment_and_management"></Image>
            </Grid>
          </Grid>
        </Card>
      </Box>
      ...
      <Box my={5}>
        <Card className="py-10">
          <Grid container>
            <Grid item xs={12} md={6} lg={6} xl={6} >
              <Image src={veeam_img01} className="w-full h-auto" alt="centralized_agent_deployment_and_management"></Image>
            </Grid>
            <Grid item xs={12} md={6} lg={6} xl={6} className="flex flex-col items-center justify-center">
              <Box textAlign="center" my={3} p={3}>
      ...
      <Box my={5}>
        <Card className="py-10">
          <Grid container>
            ...
            <Grid item xs={12} md={6} lg={6} xl={6} >
              <Image src={veeam_azure} className="w-full h-auto" alt="veeam_azure"></Image>
            </Grid>
          </Grid>
        </Card>
      </Box>
      ...
      <Box my={5} sx={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
        ...
        <Typography className="my-3 text-[2rem] w-3/4">Tại Turbo Solutions, chúng tôi luôn cam kết sẽ mang lại những giá trị tốt nhất cho khách hàng qua những dịch vụ và công nghệ tối ưu.</Typography>
      </Box>
      ...
      <Box my={5}>
        <Typography className="text-[2rem] text-blue-900 text-center font-semibold my-5">Giao diện quản lý Cloud Backup</Typography>
        <Card className="relative px-1 rounded-md hover:shadow-lg cursor-pointer">
          <CardContent>
            ...
            <Image className="w-full min-h-[350px] rounded-lg" src={manager_interface} title="Giao diện quản lý Cloud Backup" alt="Giao diện quản lý Cloud Backup" />
          </CardContent>
        </Card>
      </Box>
      ...
      <Box my={5}>
        <Typography className="text-[2rem] text-blue-900 text-center font-semibold">Các thông tin thường gặp về Cloud Backup</Typography>
        <Grid container my={5}>
          <Grid item xs={12} md={6} lg={6} xl={6} className="flex flex-col items-center justify-center">
            <Typography className="w-2/3 text-xl font-semibold">Cloud Backup là gì?</Typography>
            <Typography className="w-2/3">Sao lưu đám mây, sao lưu trực tuyến, hoặc sao lưu từ xa là thuật ngữ chỉ về
              công nghệ mới, cung cấp cách sao lưu dữ liệu của bạn thông qua dịch vụ của nhà cung cấp sao lưu đám mây.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6} lg={6} xl={6} className="flex flex-col items-center justify-center">
            <Typography className="w-2/3 text-xl font-semibold">Cloud Backup an toàn như thế nào?</Typography>
        ...
        <Grid container my={5}>
          <Grid item xs={12} md={6} lg={6} xl={6} className="flex flex-col items-center justify-center">
            <Typography className="w-2/3 text-xl font-semibold">Vì sao nên sử dụng Cloud Backup?</Typography>
            <Typography className="w-2/3">
          ...
          <Grid item xs={12} md={6} lg={6} xl={6} className="flex flex-col items-center justify-center">
            <Typography className="w-2/3 text-xl font-semibold">Các hạn chế dữ liệu của dịch vụ Cloud Backup là gì?</Typography>
            <Typography className="w-2/3">
