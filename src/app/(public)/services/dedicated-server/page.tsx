...
import { dedicatedServerBenefits, decicatedServerPrices, dedicatedServerQuestions } from "app/libs/data";
    ...
    <>
      <Container>
        <Box sx={{ textAlign: "center", py: 10 }}>
          ...
          <Box my={5}>
            <Button href="tel:0769999967" className="fancy hover:opacity-80">
                ...
                {dedicatedServerBenefits.map((item) => {
                  return (
                    <Box key={item.id} sx={{ display: "flex", alignItems: "center", py: 1 }}>
                      ...
                      <Box>
                        <Typography className="text-[1.3rem] font-semibold "> {item.title} </Typography>
                        <Typography className="pr-5 text-justify"> {item.desc} </Typography>
                      </Box>
                    </Box>
                  )
                })}
