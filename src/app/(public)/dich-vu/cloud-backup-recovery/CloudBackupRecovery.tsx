...
const CloudBackupRecovery = () => {
  return (
    <Box>
      <Box py={5} sx={{ textAlign: "center", marginX: "auto" }}>
          ...
          <Box className="">
            <Grid container>
              ...
              >
                <Box textAlign="center" px={3}>
                  ...
                  <Typography className="text-[1rem] md:text-lg text-sky-900">
                    ...
                    thiết kế đơn giản, bạn có thể dễ dàng sao lưu, phục hồi và
                    mở rộng nhanh chóng.
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={6}>
                <Image
                  src={centralized_agent_deployment_and_management}
                  className="w-full h-full rounded-xl"
                  alt="centralized_agent_deployment_and_management"
                />
              </Grid>
            </Grid>
          </Box>
              ...
              >
                <Box textAlign="center" px={3}>
                  ...
                  <Typography className="text-[1rem] md:text-lg text-sky-900 pt-2">
                    ...
                    hợp đầy đủ, nhanh chóng và an toàn để sao lưu và đồng bộ đến
                    kho lưu trữ đám mây.
                  </Typography>
                </Box>
              </Grid>
            ...
            >
              <Box textAlign="center" px={3}>
                ...
                <Typography className="text-[1rem] md:text-lg text-sky-900 pt-2">
                  ...
                  click thông qua trình duyệt bảo mật, hay chuyển đổi ngay lập
                  tức một vài VM được chọn.
                </Typography>
              </Box>
            </Grid>
        ...
        <Card className="rounded-xl">
          <Grid container>
            ...
            >
              ...
              <Box my={3} className="hidden lg:flex justify-between">
                <Box className="flex flex-col justify-center items-center mx-5">
                  <Image src={icon_01} className="w-16 h-16" alt="" />
                  <Typography className="text-[0.75rem]">Veeam B&R</Typography>
                </Box>

                <Box className="flex flex-col justify-center items-center mx-5">
                  <Image src={icon_02} className="w-16 h-16" alt="" />
            ...
            <Grid
              ...
              lg={5}
              xl={5}
              className="bg-sky-600 py-5 px-auto"
            >
              <Grid pl={8}>
                <Box>
                  ...
                  <Typography className="w-3/4 text-white">
                    Không tính phí truyền dữ liệu sao lưu và khôi phục, giúp bạn
                    thực hiện nhiều lịch sao lưu nhất có thể.
                  </Typography>
                </Box>
                <hr className="my-5" />
                ...
                <Box>
                  <Typography className="text-[1.3rem] font-semibold text-white">
                    Hỗ trợ cài đặt, triển khai
                  </Typography>
                  <Typography className="w-3/4 text-white">
                    Các chuyên gia dữ liệu của chúng tôi sẽ giúp bạn cài đặt và
                ...
                <Box>
                  ...
                  <Typography className="w-3/4 text-white">
                    Các báo cáo tóm tắt được gởi tự động theo lịch trình giúp
                    việc quản lý công việc sao lưu trở nên dễ dàng.
                  </Typography>
                </Box>
              </Grid>
            </Grid>
      ...
      <Container className="hidden lg:block">
        ...
        >
          ...
          <Button
            href="/contact"
            variant="contained"
            className="btn-astro hover:duration-700 hover:opacity-80"
          >
      ...
      <Paper className="mb-5 rounded-none">
        ...
        <Container>
          <Typography className="text-[1rem] font-light py-3">
            ...
            Không cần phải lo lắng về việc sao lưu dữ liệu, giải pháp Cloud
            Backup giúp bạn tiết kiệm thời gian và tiền bạc, giúp bạn tập trung
            ít hơn vào việc sao lưu và tập trung nhiều hơn vào việc thúc đẩy
            phát triển doanh nghiệp.
          </Typography>
          <Image
            className="w-full h-auto rounded-lg"
            src={manager_interface}
            title="Giao diện quản lý Cloud Backup"
            alt="Giao diện quản lý Cloud Backup"
          />
        </Container>
      </Paper>
      ...
      <Box className="py-10">
        ...
        <Grid container pt={5}>
          ...
          >
            ...
            <Typography className="w-3/4">
              Sao lưu đám mây, sao lưu trực tuyến, hoặc sao lưu từ xa là thuật
              ngữ chỉ về công nghệ mới, cung cấp cách sao lưu dữ liệu của bạn
              thông qua dịch vụ của nhà cung cấp sao lưu đám mây.
            </Typography>
          </Grid>
          ...
          >
            ...
            <Typography className="w-3/4">
              Mục đích chính của sao lưu đám mây là bảo vệ tất cả dữ liệu của
              bạn, vì vậy mã hóa đầu cuối là một tính năng quan trọng được tích
              hợp sẵn.
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container pt={2}>
          ...
          >
            <Typography className="w-3/4 text-xl font-semibold">
              Vì sao nên sử dụng Cloud Backup?
            </Typography>
            <Typography className="w-3/4">
              Sử dụng Cloud Backup là một cách kinh tế và an toàn để bảo vệ tất
              cả dữ liệu. Khi máy tính nhiễm virus hoặc ransomware, bạn sẽ luôn
              có các dữ liệu quan trọng mà bạn đã sao lưu trực tuyến.
            </Typography>
          </Grid>
          ...
          >
            ...
            <Typography className="w-3/4">
              Chúng tôi không đặt bất kỳ giới hạn nào trên các tệp dữ liệu. Bạn
              có thể lưu trữ nhiều hoặc ít tùy theo nhu cầu của mình. Bạn cũng
              có thể sao lưu nhiều phiên bản với băng thông không hạn chế.
            </Typography>
          </Grid>
        </Grid>
      </Box>
...
export default CloudBackupRecovery;
