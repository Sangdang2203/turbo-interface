  ...
  return (
    <Container>
      ...
      <Box className="flex justify-between items-center md:py-10">
        <Image src={Hyper_V} alt="Hyper_V" className="hidden lg:block" />
        <Image src={Vmware} alt="Vmware" className="hidden lg:block" />
        <Image src={SapHana} alt="SapHana" className="hidden lg:block" />
        <Image
          src={ActiveDirectory}
          alt="ActiveDirectory"
          className="hidden lg:block"
        />
        <Image src={SQLServer} alt="SQLServer" className="hidden lg:block" />
        <Image src={Oracle} alt="Oracle" className="hidden lg:block" />
      </Box>
      ...
      <Grid container className="pb-5 rounded-2xl my-0 md:my-10">
        <Grid item xs={12} md={6} className=" text-sky-900">
          <Grid pl={8}>
