...
import ethereum from "@/images/cloudFlare/ethereum.png";
import ethereumStructure from "@/images/cloudFlare/Etherum-Gateway-thumbnail.png";
import { Box, Typography, Grid, Button, Paper, Container } from "@mui/material";
import { cloudflareEthereumPackages, cloudflareEthereum } from "app/libs/data";
        ...
        <Paper className="rounded-none shadow-xl pt-10">
          <Grid container>
            <Grid item xs={12} md={6} className="px-4 md:pl-10">
              ...
              <Typography py={1}>
                CloudFlare Ethereum Gateway là một dịch vụ được Cloudflare cung
                cấp. Dịch vụ này cho phép các nhà phát triển tạo và quản lý tài
                khoản Ethereum, thực hiện các giao dịch Ethereum và truy vấn
                thông tin từ blockchain Ethereum thông qua giao diện HTTP (API).
                Điều này giúp giảm độ trễ khi thực hiện các hoạt động trên
                blockchain, đồng thời cải thiện trải nghiệm người dùng.
              </Typography>
            </Grid>
