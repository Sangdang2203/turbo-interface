...
import cndStructure from "@/images/cloudFlare/Cloudflare-cdn-cau-truc.jpg";
import CloundFlareCDN from "@/images/cloudFlare/cloud-cdn.png";
import {
  Box,
  Typography,
  Grid,
        ...
        <Paper className="rounded-none shadow-xl py-10">
          <Grid container>
            <Grid item xs={12} md={6} className="px-4 md:pl-10">
              ...
              <Typography py={1}>
                Cloudflare CDN cung cấp khả năng phân phối nội dung tĩnh và động
                cực nhanh qua mạng toàn cầu của chúng tôi. Thực hiện quyền kiểm
                soát chính xác đối với cách nội dung của bạn được lưu vào bộ nhớ
                đệm, giảm chi phí băng thông và tận dụng tính năng bảo vệ DDoS
                không định lượng được tích hợp sẵn.
              </Typography>
            </Grid>
